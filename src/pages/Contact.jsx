...
const COPY = {
  ...
  hi: {
    ...
    includeItems: [
      "अकाउंट की समस्या — आपके अकाउंट का ईमेल/यूज़रनेम और क्या गड़बड़ हुई।",
      "कंटेंट रिपोर्ट — कहानी, एपिसोड या कमेंट का लिंक, और रिपोर्ट करने की वजह।",
      "कॉपीराइट शिकायत — उल्लंघन करने वाले कंटेंट का लिंक, आपके स्वामित्व का प्रमाण, और आपकी संपर्क जानकारी।",
      "बिज़नेस और विज्ञापन पूछताछ — आप कौन हैं और क्या सोच रहे हैं, इसका छोटा परिचय।",
    ],
    inApp: "ऐप के अंदर रिपोर्ट करें",
    inAppP: (
      <>
        किसी भी कमेंट को कहानी के अंदर उसके ⋮ मेन्यू से सीधे रिपोर्ट भी कर सकते हैं। रिपोर्ट
        मॉडरेशन कतार में जाती हैं और हमारी कंटेंट पॉलिसी के हिसाब से जाँची जाती हैं।
      </>
    ),
  },
};
