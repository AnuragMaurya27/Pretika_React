...
const COPY = {
  ...
  hi: {
    ...
    what1: (
      <>
        प्रेतिका एक कहानी-प्लेटफ़ॉर्म है, जो उस एक चीज़ को समर्पित है जिससे हम सब चुपके-चुपके
        प्यार करते हैं: डर। यहाँ हिंदी, हिंग्लिश और अंग्रेज़ी में लिखी ओरिजिनल हॉरर कहानियाँ
        छपती हैं — भूतों की कहानियाँ, भुतहा हवेलियाँ, शहरी किंवदंतियाँ, चुड़ैल और जिन्न के किस्से,
        गाँव का ख़ौफ़ और साइकोलॉजिकल थ्रिलर — जिन्हें स्वतंत्र भारतीय लेखकों का बढ़ता समुदाय लिखता है।
      </>
    ),
    what2: (
      <>
    ...
    standardsP: (
      <>
        हॉरर स्वभाव से ही तीखा होता है, पर प्रेतिका पहले कल्पना (फ़िक्शन) है और समुदाय द्वारा
        मॉडरेट होती है। नफ़रत फैलाने वाला कंटेंट, नाबालिगों से जुड़ा यौन कंटेंट, किसी की निजी
        जानकारी उजागर करना, या असल दुनिया में नुक़सान बढ़ावा देने वाला कंटेंट यहाँ मना है। पाठक
        किसी भी कहानी या कमेंट को रिपोर्ट कर सकते हैं, और हमारी टीम हर रिपोर्ट देखती है। पूरी
        कंटेंट पॉलिसी के लिए <Link to="/terms">उपयोग की शर्तें</Link> देखें।
      </>
    ),
    who: "प्रेतिका कौन चलाता है?",
    who1: (
      <>
        प्रेतिका एक स्वतंत्र भारतीय प्लेटफ़ॉर्म है, जिसे एक छोटी सी टीम ने बनाया है — वही टीम जो
        बचपन में बत्ती बुझते ही भूतों की कहानियाँ सुनाया करती थी। हमारा मक़सद सीधा है: हिंदी हॉरर
        — और उसके लेखकों — को वह घर देना जिसके वे हक़दार हैं।
      </>
    ),
    who2: (
      <>
