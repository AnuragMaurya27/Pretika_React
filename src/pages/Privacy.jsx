...
const COPY = {
  ...
  hi: {
    ...
    subtitle: "हम क्या इकट्ठा करते हैं, क्यों करते हैं, और आपके पास क्या विकल्प हैं।",
    sections: [
      {
        h: "हम कौन हैं",
        body: [
      ...
      },
      {
        ...
        body: [
          <Ul key="1" items={[
            <><strong>अकाउंट जानकारी</strong> — रजिस्टर करते समय हम आपका ईमेल, यूज़रनेम, नाम और पासवर्ड (सुरक्षित हैश के रूप में) लेते हैं। बायो या अवतार जोड़ना वैकल्पिक है।</>,
      ...
      {
        h: "डेटा रखने की अवधि और सुरक्षा",
        body: [
          <p key="1">
            ...
            सुरक्षा (एन्क्रिप्टेड कनेक्शन, हैश किए पासवर्ड, टोकन-आधारित ऑथेंटिकेशन) इस्तेमाल करते
